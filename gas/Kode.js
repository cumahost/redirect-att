...
function responseJSON(data) {
  // ContentService TextOutput does not support custom headers in Apps Script runtime.
  // Return JSON payload; CORS headers may be handled by the client hosting or by a Worker/proxy.
